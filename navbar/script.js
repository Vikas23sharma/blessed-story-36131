function Navbar(){
    ...
    <!-- Men's page -->
      <div class="dropdown" style="background-color:white">
        <a href="product_page.html"><button class="dropbtn" id="MENSPAGE" >MEN</button></a>
    ...
    <!-- Women page -->
      <div class="dropdown">
      <a href=""><button class="dropbtnW" id="Womenpage">WOMEN</button></a>
      ...
      <div class="dropdown">
       <a href=""><button class="dropbtnK" id="kidspage" >KIDS</button></a>
